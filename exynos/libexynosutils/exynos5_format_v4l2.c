    ...
    int hal_pixel_format)
{
   ...
   case HAL_PIXEL_FORMAT_CUSTOM_CrYCbY_422_I:
    ...
    default:
        SLOGE("%s::unmatched HAL_PIXEL_FORMAT color_space(0x%x)\n",
    ...
    int v4l2_pixel_format)
{
    ...
    default:
        SLOGE("%s::unmatched V4L2_PIX color_space(%d)\n",
    ...
    int height)
{
    ...
    default:
        SLOGD("%s::no matching source colorformat(0x%x), width(%d), h(%d) fail\n",
