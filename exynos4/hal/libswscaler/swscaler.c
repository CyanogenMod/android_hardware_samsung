...
void SW_Scale_up_Y(unsigned int srcImageWidth, unsigned int srcImageHeight, unsigned int dstImageWidth, unsigned int dstImageHeight, unsigned int MainHorRatio, unsigned int MainVerRatio, unsigned char *total, unsigned char 
*total2)
{
    SW_Scale_up_Y_NEON(srcImageWidth, srcImageHeight, dstImageWidth, dstImageHeight, MainHorRatio, MainVerRatio, total, total2);
}

void SW_Scale_up_CbCr(unsigned int srcImageWidth, unsigned int srcImageHeight, unsigned int dstImageWidth, unsigned int dstImageHeight, unsigned int MainHorRatio, unsigned int MainVerRatio, unsigned char *total, unsigned char 
*total2)
{
