...
char const*const LED_PULSE = "/sys/class/sec/led/led_blink";

#define MAX_BLINK_CMD 25

struct led_config {
    int red;
    int green;
    int blue;
    char blink[MAX_BLINK_CMD];
};
...
static int set_light_leds(struct light_state_t const *state, int type)
{
    ...
    colorRGB = state->color;
   	...
   	snprintf(led.blink, MAX_BLINK_CMD, "0x00 0 0");
	...
	case LIGHT_FLASH_HARDWARE:
            ...
            snprintf(led.blink, MAX_BLINK_CMD, "0xFF 80 2000");
		break;
	default:
		return -EINVAL;
	}
