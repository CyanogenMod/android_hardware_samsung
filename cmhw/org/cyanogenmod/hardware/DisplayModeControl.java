...
public class DisplayModeControl {
    ...
    public static DisplayMode getCurrentMode() {
        try {
            int current = Integer.parseInt(FileUtils.readOneLine(MODE_PATH));
            return DISPLAY_MODES[current];
    ...
    public static DisplayMode getDefaultMode() {
        try {
            int default = Integer.parseInt(FileUtils.readOneLine(DEFAULT_PATH));
