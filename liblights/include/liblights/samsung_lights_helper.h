...
/*
 * Interfaces for other modules accessing panel brightness data.
 * For documentation, see lights_helper.c
 */
inline int get_cur_panel_brightness();
inline int get_max_panel_brightness();
inline void set_cur_panel_brightness(const int brightness);
inline void set_max_panel_brightness(const int brightness);
